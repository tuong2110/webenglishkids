...
<style>
    ...
    /* Linh vật hiển thị trong trang làm bài - rất nhỏ gọn */
    .linhvat-display-study {
        position: fixed;
        bottom: 15px;
        right: 15px;
        width: 30px;
    ...
    .linhvat-display-study:hover {
        transform: scale(1.35) translateY(-2px);
        animation: none;
    }
    
    .linhvat-display-study img {
        width: 100%;
        height: 100%;
        object-fit: cover;
        border-radius: 50%;
    ...
    .linhvat-display-study:hover .linhvat-display-study__info {
        opacity: 1;
    }
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (json.status === "complete") {
                    if (json.diemThuong) {
                        toastr.success(json.message || "Hoàn thành bài học! Nhận được " + json.diemThuong + " điểm thưởng!", "Thành công!");
                    } else {
